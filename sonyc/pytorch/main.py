...
from models import Cnn_5layers_AvgPooling, Cnn_9layers_MaxPooling, Cnn_9layers_AvgPooling, Cnn_13layers_AvgPooling, Cnn_9layers_AvgPooling_Emb, Cnn_9layers_AvgPooling_GCNEmb, Cnn_9layers_AvgPooling_GATEmb, Cnn_9layers_AvgPooling_RGCNEmb, Cnn_9layers_AvgPooling_DoubleGCNInterEmb
...
graph_models = {"Cnn_9layers_AvgPooling_GCNEmb", "Cnn_9layers_AvgPooling_GATEmb", "Cnn_9layers_AvgPooling_RGCNEmb"}

double_graph_models = {"Cnn_9layers_AvgPooling_DoubleGCNInterEmb"}

def get_model(classes_num, model_type, args):
    Model = eval(model_type)
    if model_type in double_graph_models:
        ...
        model = Model(classes_num, graph1, graph2, class_indices)
...
def train(args):
    ...
    _temp_submission_path = os.path.join(workspace, '_temp_submissions', filename, 
        '{}logmel_{}frames_{}melbins'.format(prefix, frames_per_second, mel_bins), 
        'taxonomy_level={}'.format(taxonomy_level), 
        'holdout_fold={}'.format(holdout_fold), model_marker, '_submission.csv')
...
def inference_validation(args):
    ...
    submission_path = os.path.join(workspace, 'submissions', filename, 
        '{}logmel_{}frames_{}melbins'.format(prefix, frames_per_second, mel_bins), 
        'taxonomy_level={}'.format(taxonomy_level), 
        'holdout_fold={}'.format(holdout_fold), model_marker, 'submission.csv')
...
if __name__ == '__main__':
    ...
    parser_train.add_argument('--graph_dir', type=str, help='Directory of graph.')
    parser_train.add_argument('--graph_dir2', type=str, help='Directory of graph2, only used in double graph models.')
    ...
    parser_train.add_argument('--max_iters', type=int, default=5000)
    ...
    parser_inference_validation.add_argument('--graph_dir', type=str, help='Directory of graph.')
    parser_inference_validation.add_argument('--graph_dir2', type=str, help='Directory of graph2, only used in double graph models.')
