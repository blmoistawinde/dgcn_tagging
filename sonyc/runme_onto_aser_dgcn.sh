...
FINE_GRAPH_DIR2='./data/aser_pre_conj_wt_fid.pkl'
COARSE_GRAPH_DIR2='./data/aser_pre_conj_wt_cid.pkl'
...
# Hyper-parameters
GPU_ID=1
MODEL_TYPE='Cnn_9layers_AvgPooling_DoubleGCNInterEmb'
BATCH_SIZE=32
...
# Train
CUDA_VISIBLE_DEVICES=$GPU_ID python pytorch/main.py train --dataset_dir=$DATASET_DIR --graph_dir $FINE_GRAPH_DIR --graph_dir2=$FINE_GRAPH_DIR2 --workspace=$WORKSPACE --taxonomy_level=fine --model_type=$MODEL_TYPE --holdout_fold=1 --batch_size=$BATCH_SIZE --lr=3e-4 --cuda
...
CUDA_VISIBLE_DEVICES=$GPU_ID python pytorch/main.py train --dataset_dir=$DATASET_DIR --graph_dir $COARSE_GRAPH_DIR --graph_dir2=$COARSE_GRAPH_DIR2 --workspace=$WORKSPACE --taxonomy_level=coarse --model_type=$MODEL_TYPE --holdout_fold=1 --batch_size=$BATCH_SIZE --lr=3e-4 --cuda
